...
// File generated on 27.07.2002 11:48:02 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\WINNT\System32\capicom.dll (1)
...
const
  ...
  CLASS_CertificateStatus: TGUID = '{16951EE6-A455-47CA-A78B-F98DA566B604}';
  ...
  CLASS_Certificate: TGUID = '{E38FD381-6404-4041-B5E9-B2739258941F}';
  ...
  CLASS_Certificates: TGUID = '{FBAB033B-CDD0-4C5E-81AB-AEA575CD1338}';
  ...
  CLASS_Chain: TGUID = '{65104D73-BA60-4160-A95A-4B4782E7AA62}';
  ...
  CLASS_Store: TGUID = '{78E61E52-0E57-4456-A2F2-517492BCBF8F}';
...
// *********************************************************************//
  ICertificate = interface(IDispatch)
    ...
    function IsValid: ICertificateStatus2; safecall;
...
// *********************************************************************//
  ICertificateDisp = dispinterface
    ...
    function IsValid: ICertificateStatus2; dispid 12;
...
// *********************************************************************//
  ICertificates2 = interface(ICertificates)
    ...
    function Find(FindType: CAPICOM_CERTIFICATE_FIND_TYPE; varCriteria: OleVariant; 
                  bFindValidOnly: WordBool): ICertificates; safecall;
    function Select(const Title: WideString; const DisplayString: WideString; bMultiSelect: WordBool): ICertificates; safecall;
...
// *********************************************************************//
  ICertificates2Disp = dispinterface
    ['{7B57C04B-1786-4B30-A7B6-36235CD58A14}']
    function Find(FindType: CAPICOM_CERTIFICATE_FIND_TYPE; varCriteria: OleVariant; 
                  bFindValidOnly: WordBool): ICertificates; dispid 2;
    function Select(const Title: WideString; const DisplayString: WideString; bMultiSelect: WordBool): ICertificates; dispid 3;
    procedure Add(const pVal: ICertificate); dispid 4;
...
// *********************************************************************//
  IChain = interface(IDispatch)
    ...
    function Build(const pICertificate: ICertificate2): WordBool; safecall;
...
// *********************************************************************//
  IChainDisp = dispinterface
    ['{77F6F881-5D3A-4F2F-AEF0-E4A2F9AA689D}']
    property Certificates: ICertificates2 readonly dispid 0;
    property Status[Index: Integer]: Integer readonly dispid 1;
    function Build(const pICertificate: ICertificate2): WordBool; dispid 2;
  end;
...
// *********************************************************************//
  IStore = interface(IDispatch)
    ...
    procedure Remove(const pVal: ICertificate2); safecall;
...
// *********************************************************************//
  IStoreDisp = dispinterface
    ...
    procedure Add(const pVal: ICertificate2); dispid 2;
    procedure Remove(const pVal: ICertificate2); dispid 3;
...
// *********************************************************************//
  ISigner = interface(IDispatch)
    ...
    function Get_Certificate: ICertificate2; safecall;
    procedure Set_Certificate(const pVal: ICertificate2); safecall;
    function Get_AuthenticatedAttributes: IAttributes; safecall;
    property Certificate: ICertificate2 read Get_Certificate write Set_Certificate;
...
// *********************************************************************//
  ISignerDisp = dispinterface
    ['{51017B88-1913-49AD-82BE-6BB7C417DCF2}']
    property Certificate: ICertificate2 dispid 0;
...
// *********************************************************************//
  ISigner2 = interface(ISigner)
    ...
    function Get_Chain: IChain2; safecall;
    ...
    property Chain: IChain2 read Get_Chain;
...
// *********************************************************************//
  ISigner2Disp = dispinterface
    ['{625B1F55-C720-41D6-9ECF-BA59F9B85F17}']
    property Chain: IChain2 readonly dispid 2;
...
// *********************************************************************//
  ISignedData = interface(IDispatch)
    ...
    function Get_Certificates: ICertificates2; safecall;
    function Sign(const pSigner: ISigner2; bDetached: WordBool; EncodingType: CAPICOM_ENCODING_TYPE): WideString; safecall;
    function CoSign(const pSigner: ISigner2; EncodingType: CAPICOM_ENCODING_TYPE): WideString; safecall;
...
// *********************************************************************//
  ISignedDataDisp = dispinterface
    ...
    property Certificates: ICertificates2 readonly dispid 2;
    function Sign(const pSigner: ISigner2; bDetached: WordBool; EncodingType: CAPICOM_ENCODING_TYPE): WideString; dispid 3;
    function CoSign(const pSigner: ISigner2; EncodingType: CAPICOM_ENCODING_TYPE): WideString; dispid 4;
    procedure Verify(const SignedMessage: WideString; bDetached: WordBool; 
...
// *********************************************************************//
  ISignedCode = interface(IDispatch)
    ...
    function Get_Signer: ISigner; safecall;
    function Get_TimeStamper: ISigner; safecall;
    function Get_Certificates: ICertificates; safecall;
    procedure Sign(const pISigner2: ISigner); safecall;
    ...
    property Signer: ISigner read Get_Signer;
    property TimeStamper: ISigner read Get_TimeStamper;
...
// *********************************************************************//
  ISignedCodeDisp = dispinterface
    ...
    property Signer: ISigner readonly dispid 3;
    property TimeStamper: ISigner readonly dispid 4;
    property Certificates: ICertificates readonly dispid 5;
    procedure Sign(const pISigner2: ISigner); dispid 6;
...
// create instances of the default interface ICertificateStatus exposed by              
// the CoClass CertificateStatus. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoCertificateStatus = class
    class function Create: ICertificateStatus;
    class function CreateRemote(const MachineName: string): ICertificateStatus;
  end;
...
// create instances of the default interface IChain exposed by              
// the CoClass Chain. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoChain = class
    class function Create: IChain;
    class function CreateRemote(const MachineName: string): IChain;
  end;

// *********************************************************************//
// The Class CoStore provides a Create and CreateRemote method to          
// create instances of the default interface IStore exposed by              
// the CoClass Store. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoStore = class
    class function Create: IStore;
    class function CreateRemote(const MachineName: string): IStore;
  end;
...
// create instances of the default interface ISigner exposed by              
// the CoClass Signer. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoSigner = class
    class function Create: ISigner;
    class function CreateRemote(const MachineName: string): ISigner;
  end;
...
class function CoCertificateStatus.Create: ICertificateStatus;
begin
  Result := CreateComObject(CLASS_CertificateStatus) as ICertificateStatus;
end;

class function CoCertificateStatus.CreateRemote(const MachineName: string): ICertificateStatus;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_CertificateStatus) as ICertificateStatus;
end;
...
class function CoChain.Create: IChain;
begin
  Result := CreateComObject(CLASS_Chain) as IChain;
end;

class function CoChain.CreateRemote(const MachineName: string): IChain;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_Chain) as IChain;
end;

class function CoStore.Create: IStore;
begin
  Result := CreateComObject(CLASS_Store) as IStore;
end;

class function CoStore.CreateRemote(const MachineName: string): IStore;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_Store) as IStore;
end;
...
class function CoSigner.Create: ISigner;
begin
  Result := CreateComObject(CLASS_Signer) as ISigner;
end;

class function CoSigner.CreateRemote(const MachineName: string): ISigner;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_Signer) as ISigner;
end;
